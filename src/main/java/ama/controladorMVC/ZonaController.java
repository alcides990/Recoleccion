...
public class ZonaController {
    ...
    private void cargarFormulario(Model model) {
        boolean root = esRoot();
        model.addAttribute("titulo", "zona");
        model.addAttribute("esRoot", root);
        model.addAttribute("sucursalSesion", getSucursalSession());
        model.addAttribute("cobradores", cobradorService.listarIsEstadoActivo(getSucursalSession()));
        model.addAttribute("sucursales", root ? servicioSucursal.listar() : List.of(getSucursalSession()));
        model.addAttribute("ciudad", servicioCiudad.listarCiudad());
    }
