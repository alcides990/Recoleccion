...
public class ComprobanteAccionControllerV2 {
    ...
    public ResponseEntity<Map<String, String>> editar(@RequestBody @Valid ComprobanteAccionV2 solicitud) {
        ...
        if (cambiaCuenta) {
            ...
            comprobante.setCuentaCorriente(servicioDestino.getCuentaCorriente());
        }
    ...
    public ResponseEntity<Map<String, String>> anular(@RequestBody @Valid ComprobanteAccionV2 solicitud) {
        ...
        var ultimoActivo = comprobantes.findFirstByServicio_CuentaCorrienteAndComprobantePK_PuntoExpedicionPK_CodigoSucursalAndEstado_CodigoEstadoOrderByFechaEmisionDesc(
                comprobante.getServicio().getCuentaCorriente(),
                comprobante.getComprobantePK().getPuntoExpedicionPK().getCodigoSucursal(), 1);
    ...
    private Servicio buscarServicioEdicion(String cuentaCorriente, UsuarioSistema usuarioSesion) {
        ...
        Servicio servicio = servicios.encontrar(cuenta, usuarioSesion.getSucursal().getCodigoSucursal());
