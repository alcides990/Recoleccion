...
public class UbicacionServicioService {
    ...
    public DetalleUbicacion consultar(String cuentaCorriente, Integer codigoSucursal) {
        List<UbicacionActual> ubicaciones = jdbcTemplate.query("""
                ...
                cuentaCorriente, codigoSucursal);
    ...
    public DetalleUbicacion guardar(String cuentaCorriente, BigDecimal latitud,
            ...
            Integer codigoUsuarioSistema, Integer codigoSucursal) {
        return guardar(cuentaCorriente, latitud, longitud, precisionMetros,
                metodo, codigoUsuarioSistema, codigoSucursal, "WEB");
    }
    ...
    public DetalleUbicacion guardar(String cuentaCorriente, BigDecimal latitud,
        ...
        jdbcTemplate.queryForObject("""
                ...
                WHERE cuenta_corriente = ?
                  AND codigo_sucursal = ?
                FOR UPDATE
                """, String.class, cuentaCorriente, codigoSucursal);
        ...
        jdbcTemplate.update("""
                INSERT INTO historial_ubicaciones_servicio
                    (cuenta_corriente, codigo_sucursal, latitud_anterior, longitud_anterior,
        ...
        jdbcTemplate.update("""
                INSERT INTO ubicaciones_servicio
                    (cuenta_corriente, codigo_sucursal, latitud, longitud, precision_metros,
                     metodo, origen, codigo_usuario_sistema)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)
                ...
                """, cuentaCorriente, codigoSucursal, latitud, longitud, precisionMetros,
                metodoNormalizado, origenNormalizado, codigoUsuarioSistema);

        return consultar(cuentaCorriente, codigoSucursal);
    }
